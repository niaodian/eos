...
npx degit niaodian/eos#eos-1.16.1 my-app
...
Versioning: `docs/eos/VERSION` (current `eos-1.16.1`). For upgrades, use `degit` to pull the new version to /tmp, merge with `diff -ru`,
