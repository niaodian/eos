...
| — | 合规代码起步骨架（🟡→脚手架） | skill `.github/skills/eos-compliance-skeletons/` + `docs/eos/examples/compliance-starter/`（redaction/consent/DSAR/audit，零依赖可跑；redaction 即 D5 数据出境门的代码形态） | 新建补强 |
